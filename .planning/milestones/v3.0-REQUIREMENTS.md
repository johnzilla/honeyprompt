# Requirements Archive: v3.0 Public Presence
...
- [x] **LAND-01**: honeyprompt.dev serves a single-page static site from docs/ folder on main branch via GitHub Pages with custom domain
- [x] **LAND-02**: Landing page fetches /stats from honeyprompt.sh and displays live aggregate counts with descriptive tier labels (URL Fetch, Conditional, Composed)
- [x] **LAND-03**: Landing page shows terminal-style loading state (blinking cursor) and graceful error fallback message when stats are unavailable
- [x] **LAND-04**: Landing page uses JetBrains Mono font, GitHub dark palette (#0d1117 bg, #e6edf3 text, #3fb950 green accent), accessible (WCAG AA contrast, 44px touch targets, visible focus rings, semantic HTML)
...
|--------|-------|------|--------|
| IDENT-01 | Phase 9 | — | Complete |
| IDENT-02 | Phase 9 | — | Complete |
