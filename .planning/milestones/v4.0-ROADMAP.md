...
Plans:
- [x] 12-01-PLAN.md — README "Deploy Your Own" rewrite + persona separation (DOCS-01, DOCS-02)
- [x] 12-02-PLAN.md — deploy/templates/ with docker-compose, systemd, Caddyfile (DEPLOY-01)
